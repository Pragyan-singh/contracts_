...
const BankApp = () => {
	...
	<div >
		...
		<div>
			<button onClick={AccountBalance}>Check Balance</button> <h3>Balance in the Account: {accbalance} </h3>
		</div>
		...
		<div>
		<h4>Click here for Account Creation. Make sure your Wallet is Connected</h4>
			<button onClick={createAccount}>Create Account</button>
			<h4>Click here to Check Account Existance</h4>
